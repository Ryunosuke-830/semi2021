...
class HumanPoseTeleop:
    ...
    def callback(self, msg):
        ...
        if msg.poses:
            ...
            if left_elbow_pos.x > left_wrist_pos.x and left_elbow_pos.y > left_wrist_pos.y and right_elbow_pos.y > right_wrist_pos.y and right_elbow_pos.x < right_wrist_pos.x:
                str = 'OK'
                rospy.loginfo_throttle(0.5,str)
            
            if left_elbow_pos.x > left_wrist_pos.x and right_elbow_pos.x < right_wrist_pos.x and left_elbow_pos.y < left_wrist_pos.y and right_elbow_pos.y < right_wrist_pos.y :
                str = 'naka'
                rospy.loginfo_throttle(0.5,str)
